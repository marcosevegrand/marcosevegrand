...
| Project Name | Grade |
|--------------|-------|
| [Document Indexing and Search Service](https://github.com/marcosevegrand/SO2425) | 20/20 |
...
<p>
  <img
    src="https://skillicons.dev/icons?i=go,c,bash,docker,kubernetes,postgres,azure"
    alt="Go, C, Bash, Docker, Kubernetes, Postgres, Azure"
  />
</p>
